...
String getEmbedData(){
  var embedData =  '{"promotioninfo":"","merchantinfo":"zamo_embeddata"}';
  return embedData;
}

String getItems({int id, String name, price}){
  var items =  '[{"itemid":$id,"itemname":"$name","itemprice":$price}]';
  return items;
}

String getBankCode() => "zalopayapp";
String getDescription(String apptransid) => "zamo_đơn hàng $apptransid";
